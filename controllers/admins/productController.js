...
class ProductController {
  static index(req, res) {
    ...
    pagination
      ...
      .then((products) => {
        const obj = Utility.getEjsData();
        obj.auth = req.session.auth;
        obj.data = products; //data array
        obj.pageTitle = 'Products';
        obj.path = '/admins/products';
        obj.errorFields = req.validateInput('fields'); //return array
        obj.errorMessages = req.validateInput('messages'); //return array
        obj.messages = req.flash(); //messages object
        obj.pagination = pagination.get();
        res.render('admins/products/index.ejs', obj);
      })
  ...
  static create(req, res) {
    const obj = Utility.getEjsData();
    obj.auth = req.session.auth;
    obj.pageTitle = 'Add Product';
    obj.path = '/admins/products/create';
    obj.errorFields = req.validateInput('fields'); //return array
    obj.errorMessages = req.validateInput('messages'); //return array
    obj.messages = req.flash(); //messages object

    res.render('admins/products/create.ejs', obj);
  }
